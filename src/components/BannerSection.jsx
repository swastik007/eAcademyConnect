      ...
      >
        ...
        >
          <button
            ...
            className="mx-[3px] box-content h-[14px] w-[30px] flex-initial cursor-pointer rounded-lg shadow-sm bg-sky-200 bg-clip-padding p-0 -indent-[999px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none"
            aria-current="true"
            aria-label="Slide 1"
          />
          <button
