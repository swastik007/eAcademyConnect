        ...
        <section
         ...
         >
            ...
            <div className="container max-w-3xl mx-auto grid grid-cols-1 gap-6 mt-12 lg:mt-16 xl:gap-10 sm:grid-cols-2 lg:grid-cols-4 p-8 lg:p-0">
                ...
                <SubjectCard title="Science" icon="images/subjects/business.png" />
                <SubjectCard title="Science" icon="images/subjects/chemistry.png" />
                <SubjectCard title="Science" icon="images/subjects/environment.png" />
                <SubjectCard title="Science" icon="images/subjects/geography.png" />
                <SubjectCard title="Science" icon="images/subjects/history.png" />
                <SubjectCard title="Science" icon="images/subjects/medicine.png" />
                <SubjectCard title="Science" icon="images/subjects/languages.png" />
                <SubjectCard title="Science" icon="images/subjects/english.png" />
                <SubjectCard title="Science" icon="images/subjects/german.png" />
                <SubjectCard title="Science" icon="images/subjects/science.png" />
